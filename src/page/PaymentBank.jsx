...
const PaymentBank = () => {
    ...
    console.error('Error updating payment status:', error);
            ...
            await api.post(`https://localhost:7227/api/User/update?id=${artworkUserId}`, data_userArtwok);
            ...
            await api.post(`https://localhost:7227/api/User/update?id=${userId}`, data_userNow);
